...
namespace JA
{
    ...
    public static class SingleConstants
    {
        ...
        public const float ulp_sq = 1f / 4096;
        public const float pi = (float)Math.PI;
        public const float deg = pi / 180;

        public const float tiny = 8*ulp, tiny_sq = 8*ulp_sq;
    ...
    public static class DoubleConstants
    {
        ...
        public const double ulp_sq = 1.0 / 67108864;
        public const double pi = Math.PI;
        public const double deg = pi / 180;

        public const double tiny = 8*ulp, tiny_sq = 8*ulp_sq;
